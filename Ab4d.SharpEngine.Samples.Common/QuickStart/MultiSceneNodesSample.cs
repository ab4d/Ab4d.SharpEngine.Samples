...
namespace Ab4d.SharpEngine.Samples.Common.QuickStart;
...
public class MultiSceneNodesSample : CommonSample
{
    ...
    protected override void OnSceneViewInitialized(SceneView sceneView)
    {
        ...
        sceneView.SceneUpdating += (sender, args) => UpdateModelWorldMatrices();
    ...
    protected override void OnCreateScene(Scene scene)
    {
        ...
        bool useArialFont = System.OperatingSystem.IsWindows();
