...
public class SkiaSharpBitmapIO : IBitmapIO
{
    ...
    internal static bool IsFileFormatSupported(string fileExtension, string[] fileFormats)
    {
    ...
    internal static byte[] ConvertGrayscaleImageDataToBgra(int width, int height, int stride, byte[] grayscaleImageData)
    {
