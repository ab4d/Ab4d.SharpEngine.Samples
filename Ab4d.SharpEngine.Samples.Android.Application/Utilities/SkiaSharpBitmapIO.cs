// This sample is using AndroidBitmapIO that is significantly faster than the SkiaSharpBitmapIO
// If you still want to use SkiaSharpBitmapIO (for example because it also supports writing to bitmaps),
// then uncomment this source file and add reference to SkiaSharp library in csproj, for example:
