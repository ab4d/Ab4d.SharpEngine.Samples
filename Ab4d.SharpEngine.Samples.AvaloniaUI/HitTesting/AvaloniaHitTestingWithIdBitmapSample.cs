...
public class AvaloniaHitTestingWithIdBitmapSample : HitTestingWithIdBitmapSample
{
    private InputElement? _subscribedElement;

    public AvaloniaHitTestingWithIdBitmapSample(ICommonSamplesContext context)
        : base(context)
    {
    }
