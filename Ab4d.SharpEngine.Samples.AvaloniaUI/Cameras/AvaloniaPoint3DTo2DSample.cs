...
public class AvaloniaPoint3DTo2DSample : Point3DTo2DSample
{
    ...
    public AvaloniaPoint3DTo2DSample(ICommonSamplesContext context)
        : base(context)
    {
    }
    ...
    protected override void CreateCustomUI(ICommonSampleUIProvider ui)
    {
        ...
        baseAvaloniaPanel.Children.Add(_rootCanvas);
    }
    ...
    private void PositionUIElements(Vector2 targetPosition)
    {
        ...
        _targetLine.StartPoint = new Point(targetPosition.X, targetPosition.Y);
        _targetLine.EndPoint = new Point(targetPosition.X + _infoRectOffset.X + 1 - _infoRectangle.Width / 2, targetPosition.Y - _infoRectOffset.Y - 1 + _infoRectangle.Height / 2);
