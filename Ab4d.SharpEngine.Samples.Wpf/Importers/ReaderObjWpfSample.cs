...
public class ReaderObjWpfSample : ReaderObjSample
{
    private DragAndDropHelper? _dragAndDropHelper;

    public ReaderObjWpfSample(ICommonSamplesContext context) 
        : base(context)
    {
    }
    ...
    protected override bool SetupDragAndDrop(ICommonSampleUIProvider ui)
    {
        ...
        _dragAndDropHelper = new DragAndDropHelper(rootFrameworkElement, ".obj");
        ...
        ui.CreateLabel("Drag and drop .obj file here to open it");
