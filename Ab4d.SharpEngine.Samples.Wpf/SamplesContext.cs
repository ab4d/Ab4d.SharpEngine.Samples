...
{
    public static readonly SamplesContext Current = new SamplesContext();


    public SharpEngineSceneView? CurrentSharpEngineSceneView { get; private set; }
    ...
    public void RegisterCurrentSharpEngineSceneView(SharpEngineSceneView? sharpEngineSceneView)
    {
        ...
        {
            sharpEngineSceneView.Unloaded += SharpEngineSceneViewOnUnloaded;
        }

        OnCurrentSharpEngineSceneViewChanged();
    }

    private void SharpEngineSceneViewOnUnloaded(object sender, RoutedEventArgs e)
    {
        if (CurrentDiagnosticsWindow != null)
        {
