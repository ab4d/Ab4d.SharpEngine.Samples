...
namespace Ab4d.SharpEngine.Samples.WinUI.QuickStart
{
    ...
    public partial class SharpEngineSceneViewInXaml : UserControl
    {
        ...
        {           
            // Set the Ab4d.SharpEngine license before the engine is initialized.
            // In this samples project, the SetLicense method is already called from the SamplesWindow.xaml.cs so this call is commented.
            // To use the Ab4d.SharpEngine in your project, get a license from ab4d.com/trial or ab4d.com/purchase 
        ...
        private void ChangeBackgroundButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            MainSceneView.BackgroundColor = WinUISamplesContext.Current.GetRandomWinUIColor();
        }
        ...
        private void ChangeMaterial1Button_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            var index = WinUISamplesContext.Current.GetRandomInt(_groupNode.Count - 1);

            if (_groupNode[index] is ModelNode modelNode)
            {
                if (modelNode.Material is StandardMaterial standardMaterial)
                    standardMaterial.DiffuseColor = WinUISamplesContext.Current.GetRandomColor3();
            }
        }
