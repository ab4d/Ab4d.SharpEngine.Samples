...
namespace Ab4d.SharpEngine.Samples.WinUI.QuickStart
{
    ...
    public partial class SharpEngineSceneViewInCode : UserControl
    {
        ...
        public SharpEngineSceneViewInCode()
        {
            ...
            _sharpEngineSceneView.CreateOptions.EnableStandardValidation = SamplesWindow.EnableStandardValidation;

            // Apply and advanced settings from the SettingsWindow
            SamplesWindow.ConfigureSharpEngineSceneViewAction?.Invoke(_sharpEngineSceneView);
