...
namespace Ab4d.SharpEngine.Samples.WinUI.Settings
{
    /// <summary>
    ...
    public partial class SettingsWindow : Page
    {
        ...
        public SettingsWindow()
        {
            ...
            ToolTipService.SetToolTip(MultisamplingComboBox,
...
For example, 4xMSAA runs pixel shader only once per each pixel but require 4 times the amount of memory.");
            ...
            ToolTipService.SetToolTip(SuperSamplingComboBox,
...
2xSSAA renders the scene to a texture with 2 times more pixels. In this case width and height are multiplied by 1.41 = sqrt(2) - SceneView.SupersamplingFactor is 1.41.");
        ...
        private void SetupDeviceInfo()
        {
            ...
            if (vulkanInstance == null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Error creating VulkanInstance: " + ex.Message);
                }
            }
            ...
            if (devicesCount > 1)
            {
                ...
                ToolTipService.SetToolTip(GpuDevicesTextBlock,
...
to the main CPU memory and then back to the application's GPU).");
        ...
        private void SetupAntialisingComboBoxes(PhysicalDeviceDetails deviceDetails)
        {
            ...
            var sharpEngineSceneView = this.SharpEngineSceneView ?? new Ab4d.SharpEngine.WinUI.SharpEngineSceneView();
